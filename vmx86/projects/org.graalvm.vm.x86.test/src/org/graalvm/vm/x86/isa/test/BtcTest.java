...
public class BtcTest extends InstructionTest {
    ...
    private static final byte[] MACHINECODE2 = {0x0f, (byte) 0xbb, (byte) 0xcd};
    private static final String ASSEMBLY2 = "btc\tebp,ecx";
    ...
    @Test
    public void test2() {
        check(MACHINECODE2, ASSEMBLY2, Btcl.class);
    }
}
