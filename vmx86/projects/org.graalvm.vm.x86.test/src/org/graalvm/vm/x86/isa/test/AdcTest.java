...
public class AdcTest extends InstructionTest {
    ...
    private static final byte[] MACHINECODE5 = {(byte) 0x80, (byte) 0xd2, 0x00};
    private static final String ASSEMBLY5 = "adc\tdl,0x0";
    ...
    @Test
    public void test5() {
        check(MACHINECODE5, ASSEMBLY5, Adcb.class);
    }
}
