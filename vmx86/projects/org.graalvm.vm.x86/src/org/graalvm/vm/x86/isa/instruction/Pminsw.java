...
public class Pminsw extends AMD64Instruction {
    ...
    protected Pminsw(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pminsw(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.minSignedPackedI16(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pminsw", operand1.toString(), operand2.toString()};
    }
}
