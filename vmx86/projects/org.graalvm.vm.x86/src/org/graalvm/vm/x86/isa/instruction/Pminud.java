...
public class Pminud extends AMD64Instruction {
    ...
    protected Pminud(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public Pminud(long pc, byte[] instruction, OperandDecoder operands) {
    ...
    public long executeInstruction(VirtualFrame frame) {
        ...
        Vector128 result = a.minUnsignedPackedI32(b);
    ...
    protected String[] disassemble() {
        return new String[]{"pminud", operand1.toString(), operand2.toString()};
    }
}
