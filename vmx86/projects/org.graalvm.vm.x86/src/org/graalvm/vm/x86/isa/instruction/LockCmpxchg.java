...
public abstract class LockCmpxchg extends AMD64Instruction {
    ...
    protected LockCmpxchg(long pc, byte[] instruction, Operand operand1, Operand operand2) {
    ...
    public static class LockCmpxchgb extends LockCmpxchg {
        public LockCmpxchgb(long pc, byte[] instruction, OperandDecoder operands) {
        ...
        public long executeInstruction(VirtualFrame frame) {
            ...
            boolean ok = writeDst.executeCmpxchgI8(frame, al, src);
            if (ok) {
    ...
    public static class LockCmpxchgw extends LockCmpxchg {
        public LockCmpxchgw(long pc, byte[] instruction, OperandDecoder operands) {
        ...
        public long executeInstruction(VirtualFrame frame) {
            ...
            boolean ok = writeDst.executeCmpxchgI16(frame, ax, src);
            if (ok) {
                writeZF.execute(frame, true);
            } else {
                writeZF.execute(frame, false);
    ...
    public static class LockCmpxchgl extends LockCmpxchg {
        public LockCmpxchgl(long pc, byte[] instruction, OperandDecoder operands) {
        ...
        public long executeInstruction(VirtualFrame frame) {
            ...
            boolean ok = writeDst.executeCmpxchgI32(frame, eax, src);
            if (ok) {
                writeZF.execute(frame, true);
            } else {
                writeZF.execute(frame, false);
    ...
    public static class LockCmpxchgq extends LockCmpxchg {
        public LockCmpxchgq(long pc, byte[] instruction, OperandDecoder operands) {
        ...
        public long executeInstruction(VirtualFrame frame) {
            ...
            boolean ok = writeDst.executeCmpxchgI64(frame, rax, src);
            if (ok) {
                writeZF.execute(frame, true);
            } else {
                writeZF.execute(frame, false);
    ...
    protected String[] disassemble() {
        return new String[]{"lock cmpxchg", operand1.toString(), operand2.toString()};
    }
}
