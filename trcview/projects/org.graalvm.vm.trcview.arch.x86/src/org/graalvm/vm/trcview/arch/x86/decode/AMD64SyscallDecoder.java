...
public class AMD64SyscallDecoder extends SyscallDecoder {
    ...
    public static String decode(AMD64CpuState state, AMD64CpuState next, TraceAnalyzer trc) {
        if (next == null) {
    ...
    public static String decode(AMD64CpuState state, TraceAnalyzer trc) {
        ...
        switch (id) {
            ...
            case Syscalls.SYS_ioctl:
                return "ioctl(" + a1 + ", " + Ioctls.toString(AMD64Ioctls.translate((int) a2)) + " /* 0x" + tohex(a2, 8) + " */, 0x" + hex(a3) + ")";
            ...
            case Syscalls.SYS_fcntl:
                return "fcntl(" + a1 + ", " + Fcntl.fcntl((int) a2) + ", " + ptr(a3) + ")";
            ...
            case Syscalls.SYS_arch_prctl:
                return "arch_prctl(" + archprctl((int) a1) + ", " + ptr(a2) + ")";
    ...
    public String decodeResult(int sc, CpuState state, TraceAnalyzer trc) {
        if (!(state instanceof AMD64CpuState)) {
            return null;
        }
        return decodeResult(sc, (AMD64CpuState) state);
    }
    ...
    public String decode(CpuState state, TraceAnalyzer trc) {
        ...
        return decode((AMD64CpuState) state, trc);
    }
}
