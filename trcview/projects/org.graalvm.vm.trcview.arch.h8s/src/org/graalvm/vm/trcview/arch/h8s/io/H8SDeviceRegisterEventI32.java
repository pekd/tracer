...
public class H8SDeviceRegisterEventI32 extends DeviceRegisterEvent {
    ...
    public H8SDeviceRegisterEventI32(int dev, int reg, int value) {
        super(0);
        this.dev = dev;
        this.reg = reg;
        this.value = value;
    ...
    public H8SDeviceRegisterEventI32(int dev, int reg, int value, boolean write) {
        super(0);
        this.dev = dev;
        this.reg = reg;
        this.value = value;
