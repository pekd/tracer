...
public class Loop extends AMD64Instruction {
    protected final long bta;

    @Child private ReadNode readRCX;
    @Child private WriteNode writeRCX;

    public Loop(long pc, byte[] instruction, int offset) {
    ...
    protected String[] disassemble() {
        return new String[]{"loop", String.format("0x%x", bta)};
    }
}
