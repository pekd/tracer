...
public abstract class EventParser {
    ...
    public abstract <T extends InterruptEvent> T parseTrap(WordInputStream in, int tid, long step, long pc, InstructionType type, byte[] machinecode) throws IOException;
}
